 ...
 * DHE AES 128-bit for older clients, if necessary (DHE-RSA-AES128-SHA); use 2048-bit DH keys or stronger, with a unique DH group per server. See the DH/DHE note, below.
